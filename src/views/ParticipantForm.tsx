...
const FIELDS: Field[] = [
  ...
  },
  {
    ...
    hint: 'תוכן, מיומנויות, מודלים, או רשתות שיעזרו לך להתפתח.',
    example: 'דוגמה: "כלים לניהול שיחות קשות עם הצוות", או: "מודלים לקבלת החלטות תחת לחץ".',
    note: 'שאלה זו פרטית. התשובה לא תוצג ולא תפורסם — היא נשארת לעיני המנחה בלבד.',
    multiline: true,
    maxLength: 240,
    rows: 3,
  },
